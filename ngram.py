# Modified by Curtis Belmonte, Jason Kim, Victor Du
...
#from nltk.model.api import ModelI  CHANGED
...
class NgramModel(ModelI):
    ...
    def _words_following(self, context, cond_freq_dist):
        #modified, didn't work after pulling
        for word in cond_freq_dist[context]:
            yield word
